...
const isSupportLineClamp =
  typeof window !== 'undefined' && document.body.style.webkitLineClamp !== undefined;
...
export default class Ellipsis extends Component {
  ...
  render() {
    ...
    const cls = `${styles.ellipsis} ${className} ${lines &&
      (isSupportLineClamp ? styles.lineClamp : styles.lines)}`;
