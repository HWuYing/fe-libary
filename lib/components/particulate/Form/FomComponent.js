...
function (_Component) {
  ...
  _createClass(FormComponent, [{
    ...
    value: function getForm(form) {
      var mergeProperties = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var getForm = this.props.getForm;
      this.form = form;

      if (form) {
        Object.keys(mergeProperties).forEach(function (key) {
          if (!(0, _tools.hasOwnProperty)(form, key)) {
...
_defineProperty(FormComponent, "initialMergeProps", function (props, clearArr) {
  return clearAttr(_objectSpread({}, props), _toConsumableArray(clearArr).concat(['getForm']));
});
