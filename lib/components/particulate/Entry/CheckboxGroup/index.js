...
var EntryCheckboxGroup =
/*#__PURE__*/
function (_PureComponent) {
  _inherits(EntryCheckboxGroup, _PureComponent);

  function EntryCheckboxGroup(props, contenx) {
    var _this;

    _classCallCheck(this, EntryCheckboxGroup);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EntryCheckboxGroup).call(this, props, contenx));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (value) {
      ...
      if (labelInValue) {
        var temp = children.filter(function (item) {
          return value.includes(item[valueName].toString());
        });
        value = temp;
      }
  ...
  _createClass(EntryCheckboxGroup, [{
    ...
    value: function initial(props) {
      ...
      ['valueName', 'labelName', 'value', 'labelInValue'].forEach(function (item) {
    ...
    value: function render() {
      ...
      return _react.default.createElement(CheckboxGroup, _extends({
        value: value
      }, this.config, {
  ...
  return EntryCheckboxGroup;
}(_react.PureComponent);

_defineProperty(EntryCheckboxGroup, "defaultValue", undefined);

var _default = EntryCheckboxGroup;
