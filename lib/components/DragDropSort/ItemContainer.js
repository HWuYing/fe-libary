...
function (_PureComponent) {
  _inherits(ItemContainer, _PureComponent);
...
_defineProperty(ItemContainer, "propTypes", {});
...
var source = {
  ...
  isDragging: function isDragging(props, monitor, component) {
    var Item = monitor.getItem();
...
var target = {
  canDrop: function canDrop(props, monitor) {
    ...
    if (props.canDrop) props.canDrop(draggedId !== dropId && monitor.isOver({
      shallow: true
    }));
    return true;
  },
  ...
  drop: function drop(props, monitor, component) {
    var _monitor$getItem3 = monitor.getItem(),
        draggedId = _monitor$getItem3.id;
...
var _default = (0, _reactDnd.DropTarget)(TYPE, target, function (connect) {
  return {
    connectDropTarget: connect.dropTarget()
  };
})((0, _reactDnd.DragSource)(TYPE, source, function (connect, monitor) {
  return {
